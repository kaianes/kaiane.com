import UnicornBackground from "@/app/components/ui/UnicornBackground";
...
export default function Hero() {
  return (
    ...
    >
      {/* Animated WebGL background — Unicorn Studio */}
      <UnicornBackground />
      ...
      {/* Contact links — desktop, top-right inside hero */}
      <div className="hidden md:flex items-center gap-6 absolute top-6 right-20 z-10 text-[13px] font-body text-soft-canvas/55">
        <a
      ...
      <div className="absolute bottom-8 md:bottom-[70px] left-6 md:left-20 right-6 md:right-auto z-10 flex items-center justify-between">
